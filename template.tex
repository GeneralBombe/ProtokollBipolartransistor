...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{Figures/scope_5 C.1.2..jpg}
	\caption{Bestimmung von $\Delta U_{BE}$ und $\Delta I_B$}
	\label{fig:Geradennäherung von r_BE}
\end{figure}

In Abbildung \ref{fig:Geradennäherung von r_BE} wurden bei $I_{B}$ folgende Werte für $\Delta U_{BE}$ und $\Delta I_B$ extrapoliert:
