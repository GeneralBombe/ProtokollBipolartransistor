...
\[
\[
R_{\text{ges}} = R_{\text{gen}} + R_{\text{Leitung}} = \frac{\Delta U_{CE}}{\Delta I_C} = \frac{4\,\mathrm{V}}{65\,\mathrm{mA}} = \frac{4}{0.065}\,\Omega \approx 61.54\,\Omega\]
...
\begin{table}[h!]
\centering
\caption{Messwerte für $I_B$, $I_C$ und berechnetes $\beta$}
\begin{tabular}{c|cccc}
\toprule
\textbf{mit $I_B$ [\si{\micro\ampere}]} & 0 & 100 & 200 & 300 & 400 \\
\midrule
$I_C$ [\si{\milli\ampere}] & 0 & 18.50 & 35.00 & 53.00 & 70.00 \\
\midrule
$\beta = \frac{I_C}{I_B}$ & -- & 185 & 175 & 176.667 & 175 \\
\bottomrule
\end{tabular}
\end{table}
