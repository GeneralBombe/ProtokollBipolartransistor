...
\title{Protokoll Praktikum EBau Bipolartransistor, Johann du Opfer} % Report title
...
\begin{figure}[H] % [H] forces the figure to be placed exactly where it appears in the text
	...
	\includegraphics[width=0.7\textwidth]{image_johann} % Include the figure, now larger
	\caption{geeeeeee geeeeeeee tung tung tung tung tung tung tung tung tung tung tung tung tung tung tung tung tung tung tung tung tung tung tung tung }
\end{figure}
